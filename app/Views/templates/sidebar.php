...
?> -->
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion fixed-start" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">POS YnK<sup></sup></div>
    </a>
...
use App\Controllers\user;
 ...
 if( in_groups('admin')) : ?>
                ...
                <a class="collapse-item" href="<?= base_url('manage') ?>">User Management</a>
                <?php endif; ?>
    ...
    <li class="nav-item active">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                <a class="collapse-item" href="<?= base_url('transaksi') ?>">Transaksi Jual</a>
                ...
                <!-- Nav Item - User Information -->
                         <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small ml-2"><?= user() -> username; ?></span>
